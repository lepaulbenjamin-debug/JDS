...
export const QUESTIONS = [
...

  {
    ...
    acceptees: [
      ...
      { titre: 'Le Papa pingouin', artiste: 'Sophie et Magaly' },
      { titre: 'Une souris verte', artiste: 'comptine' },
      { titre: 'Alouette', artiste: 'traditionnel' },
    ],
  ...
  },
  {
    ...
    acceptees: [
      ...
      { titre: 'The Lady in Red', artiste: 'Chris de Burgh' },
      ...
      { titre: 'White Wedding', artiste: 'Billy Idol' },
      { titre: 'Blackbird', artiste: 'The Beatles' },
  ...
  },
  {
    ...
    acceptees: [
      ...
      { titre: 'Maggie May', artiste: 'Rod Stewart' },
      { titre: 'Sweet Caroline', artiste: 'Neil Diamond' },
      { titre: 'Valerie', artiste: 'The Zutons' },
      { titre: 'Cecilia', artiste: 'Simon & Garfunkel' },
      { titre: 'Barbara Ann', artiste: 'The Beach Boys' },
      { titre: 'Peggy Sue', artiste: 'Buddy Holly' },
      { titre: 'Johnny B. Goode', artiste: 'Chuck Berry' },
      { titre: 'Lola', artiste: 'The Kinks' },
      { titre: 'Mathilde', artiste: 'Jacques Brel' },
      ...
      { titre: 'Ziggy', artiste: 'Céline Dion' },
      { titre: 'Gaby oh Gaby', artiste: 'Alain Bashung' },
    ],
  ...
  },
  {
    ...
    acceptees: [
      { titre: 'New York, New York', artiste: 'Frank Sinatra' },
      ...
      { titre: 'Belle-Île-en-Mer', artiste: 'Laurent Voulzy' },
  ...
  },
  {
    ...
    texte: 'Une chanson avec un nombre dans le titre',
    acceptees: [
      { titre: '99 Luftballons', artiste: 'Nena' },
      { titre: 'Summer of ’69', artiste: 'Bryan Adams' },
      { titre: 'Seven Nation Army', artiste: 'The White Stripes' },
      { titre: '50 Ways to Leave Your Lover', artiste: 'Paul Simon' },
      { titre: 'One', artiste: 'U2' },
      { titre: 'Two Princes', artiste: 'Spin Doctors' },
      { titre: 'Three Little Birds', artiste: 'Bob Marley' },
      { titre: 'Eight Days a Week', artiste: 'The Beatles' },
      { titre: '1999', artiste: 'Prince' },
      { titre: '21 Guns', artiste: 'Green Day' },
      { titre: '9 to 5', artiste: 'Dolly Parton' },
      { titre: 'Mambo No. 5', artiste: 'Lou Bega' },
      { titre: '500 Miles', artiste: 'The Proclaimers' },
      { titre: '19-2000', artiste: 'Gorillaz' },
      { titre: 'Sixteen Tons', artiste: 'Tennessee Ernie Ford' },
      { titre: 'Trois nuits par semaine', artiste: 'Alain Bashung' },
      { titre: 'Eight Miles High', artiste: 'The Byrds' },
    ],
