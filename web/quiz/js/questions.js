...
export const THEMES = [
  ...
  { id: 'potter', nom: 'Harry Potter', emoji: '🧙' },
...
export const QUESTIONS = [
  ...
  // Vocabulaire. Les mots qu'on entend sans oser les employer, et ceux qu'on
  // emploie sans être sûr : ils n'ont pas besoin d'un thème à eux — c'est la
  // même chose que « mots et expressions », vue par la définition.
  {
    id: 'mot-19', theme: 'mots',
    niveau: 1,
    texte: 'Que veut dire « obsolète » ?',
    reponses: ['Dépassé', 'Interdit', 'Rare', 'Obligatoire'],
    bonne: 0,
    note: 'Du latin obsolescere, tomber en désuétude. Une machine obsolète marche encore : elle n’a plus cours, c’est tout.',
  },
  {
    id: 'mot-20', theme: 'mots',
    niveau: 1,
    texte: 'Que veut dire « laconique » ?',
    reponses: ['Qui s’exprime en peu de mots', 'Qui parle sans s’arrêter', 'Qui parle fort', 'Qui ment avec aplomb'],
    bonne: 0,
    note: 'De la Laconie, la région de Sparte : les Spartiates répondaient en trois mots. Sommés de se rendre « sinon », ils ont répondu « si ».',
  },
  {
    id: 'mot-21', theme: 'mots',
    niveau: 2,
    texte: 'Que veut dire « idoine » ?',
    reponses: ['Qui convient parfaitement', 'Qui arrive trop tard', 'Qui se répète', 'Qui ne sert à rien'],
    bonne: 0,
    note: 'L’outil idoine est celui qu’il fallait. Le mot fait savant, il ne dit rien de plus que « approprié ».',
  },
  {
    id: 'mot-22', theme: 'mots',
    niveau: 2,
    texte: 'Que désigne un « imbroglio » ?',
    reponses: ['Une situation embrouillée', 'Un plat italien', 'Un faux document', 'Une dispute de famille'],
    bonne: 0,
    note: 'De l’italien imbrogliare, embrouiller. Le mot garde son gl mouillé : on dit « imbroglio », pas « imbroglio » à la française.',
  },
  {
    id: 'mot-23', theme: 'mots',
    niveau: 2,
    texte: 'Que désigne le don d’« ubiquité » ?',
    reponses: ['Être partout à la fois', 'Tout savoir', 'Tout voir', 'Ne jamais dormir'],
    bonne: 0,
    note: 'Du latin ubique, partout. « Je n’ai pas le don d’ubiquité » est la façon polie de refuser une deuxième invitation le même soir.',
  },
  {
    id: 'mot-24', theme: 'mots',
    niveau: 3,
    texte: 'Que veut dire « velléitaire » ?',
    reponses: ['Qui projette sans jamais agir', 'Qui agit sans réfléchir', 'Qui change d’avis', 'Qui obéit à tout le monde'],
    bonne: 0,
    note: 'La velléité est une intention si faible qu’elle ne passe jamais à l’acte. Le mot décrit une bonne moitié des résolutions de janvier.',
  },
  {
    id: 'mot-25', theme: 'mots',
    niveau: 3,
    texte: 'Que veut dire « nonobstant » ?',
    reponses: ['Malgré', 'Grâce à', 'Pendant', 'À condition que'],
    bonne: 0,
    note: 'Littéralement « ne faisant pas obstacle ». On le croise surtout dans les contrats, où il annonce presque toujours une mauvaise nouvelle.',
  },
  {
    id: 'mot-26', theme: 'mots',
    niveau: 3,
    texte: 'Que désigne l’« acrimonie » ?',
    reponses: ['Une aigreur hargneuse', 'Une timidité maladive', 'Une gourmandise', 'Une politesse excessive'],
    bonne: 0,
    note: 'Du latin acer, aigre. C’est le ton d’une réunion de copropriété qui dure depuis deux heures.',
  },
  ...
  {
    id: 'har-01', theme: 'potter',
    niveau: 1,
    texte: 'Dans quelle maison le Choixpeau envoie-t-il Harry ?',
    reponses: ['Gryffondor', 'Serpentard', 'Serdaigle', 'Poufsouffle'],
    bonne: 0,
    note: 'Le Choixpeau hésite longuement avec Serpentard — et c’est parce que Harry demande à l’éviter qu’il ne l’y met pas. Tout le livre tient dans ce détail.',
  },
  {
    id: 'har-02', theme: 'potter',
    niveau: 1,
    texte: 'Quel est le prénom du professeur Dumbledore ?',
    reponses: ['Albus', 'Aberforth', 'Alastor', 'Argus'],
    bonne: 0,
    note: 'Albus Perceval Wulfric Brian Dumbledore, rien de moins. Aberforth est son frère, celui qui tient la Tête de Sanglier.',
  },
  {
    id: 'har-03', theme: 'potter',
    niveau: 1,
    texte: 'Comment s’appelle la chouette de Harry ?',
    reponses: ['Hedwige', 'Errol', 'Coquecigrue', 'Nagini'],
    bonne: 0,
    note: 'Un cadeau de Hagrid pour ses onze ans. Errol est le hibou poussif des Weasley, et Nagini n’est pas un oiseau du tout.',
  },
  {
    id: 'har-04', theme: 'potter',
    niveau: 2,
    texte: 'Quel objet montre à Harry ses parents disparus ?',
    reponses: ['Le miroir du Riséd', 'La Pensine', 'La carte du Maraudeur', 'Le Retourneur de Temps'],
    bonne: 0,
    note: 'Riséd, c’est « désir » à l’envers : le miroir ne montre pas le passé mais ce qu’on veut le plus au monde. Dumbledore prévient que des hommes en sont morts.',
  },
  {
    id: 'har-05', theme: 'potter',
    niveau: 2,
    texte: 'Quel animal représente la maison Poufsouffle ?',
    reponses: ['Le blaireau', 'Le corbeau', 'Le lion', 'Le renard'],
    bonne: 0,
    note: 'Le blaireau pour Poufsouffle, l’aigle pour Serdaigle, le lion pour Gryffondor et le serpent pour Serpentard.',
  },
  {
    id: 'har-06', theme: 'potter',
    niveau: 3,
    texte: 'Quelle créature garde les coffres les plus profonds de Gringotts ?',
    reponses: ['Un dragon', 'Un basilic', 'Un sphinx', 'Un troll'],
    bonne: 0,
    note: 'Un dragon aveugli par l’obscurité, dressé à reculer au bruit des Clochettes. Harry, Ron et Hermione s’en servent pour s’évader.',
  },
  {
    id: 'har-07', theme: 'potter',
    niveau: 2,
    texte: 'Quel balai Harry reçoit-il en première année ?',
    reponses: ['Un Nimbus 2000', 'Un Éclair de feu', 'Un Comète 260', 'Un Brossdur 11'],
    bonne: 0,
    note: 'Offert par McGonagall, qui vient de le nommer attrapeur. L’Éclair de feu arrivera en troisième année, sans carte de vœux.',
  },
  {
    id: 'har-08', theme: 'potter',
    niveau: 2,
    texte: 'Comment s’appelle l’elfe de maison des Malefoy ?',
    reponses: ['Dobby', 'Kreattur', 'Winky', 'Fleur'],
    bonne: 0,
    note: 'Harry le libère en glissant une chaussette dans un carnet tendu à Lucius Malefoy : un vêtement donné par le maître rend un elfe libre.',
  },
  {
    id: 'har-09', theme: 'potter',
    niveau: 2,
    texte: 'Que fait le sortilège « Expelliarmus » ?',
    reponses: ['Il désarme l’adversaire', 'Il fait léviter un objet', 'Il efface la mémoire', 'Il ouvre une serrure'],
    bonne: 0,
    note: 'La baguette saute de la main. C’est le sort préféré de Harry, au point que les Mangemorts le reconnaissent à ça — et c’est lui qui finit le dernier duel.',
  },
  {
    id: 'har-10', theme: 'potter',
    niveau: 3,
    texte: 'Quelle forme prend le Patronus de Severus Rogue ?',
    reponses: ['Une biche', 'Un loup', 'Un cerf', 'Un corbeau'],
    bonne: 0,
    note: 'La même que celui de Lily Potter. Dumbledore comprend en le voyant : « Après tout ce temps ? » — « Toujours. »',
  },
  {
    id: 'har-11', theme: 'potter',
    niveau: 1,
    texte: 'Quel sport se joue sur des balais à Poudlard ?',
    reponses: ['Le Quidditch', 'Le Quaffle', 'La Bavboule', 'Les échecs version sorcier'],
    bonne: 0,
    note: 'Sept joueurs, quatre balles, et un barème que tout le monde trouve déséquilibré : cent cinquante points pour le Vif d’or, dix pour un but.',
  },
  {
    id: 'har-12', theme: 'potter',
    niveau: 3,
    texte: 'Qui a écrit « Vie et habitat des animaux fantastiques » ?',
    reponses: ['Norbert Dragonneau', 'Gilderoy Lockhart', 'Bathilda Tourdesac', 'Quirinus Quirrell'],
    bonne: 0,
    note: 'Le manuel de première année, devenu une saga de films à lui tout seul. Lockhart, lui, signait des livres qu’il n’avait pas vécus.',
  },

  /* --- Pokémon -------------------------------------------------------------- */

  {
    id: 'pok-01', theme: 'pokemon',
    niveau: 1,
    texte: 'Quel Pokémon accompagne Sacha depuis le premier épisode ?',
    reponses: ['Pikachu', 'Rondoudou', 'Évoli', 'Miaouss'],
    bonne: 0,
    note: 'Un Pikachu qui refuse d’entrer dans sa Poké Ball — c’est même toute la première scène. Miaouss, lui, parle et travaille pour la Team Rocket.',
  },
  {
    id: 'pok-02', theme: 'pokemon',
    niveau: 1,
    texte: 'De quel type est Salamèche ?',
    reponses: ['Feu', 'Eau', 'Plante', 'Vol'],
    bonne: 0,
    note: 'Sa flamme au bout de la queue dit sa santé : si elle s’éteint, il meurt. C’est écrit noir sur blanc dans le Pokédex.',
  },
  {
    id: 'pok-03', theme: 'pokemon',
    niveau: 2,
    texte: 'Quel Pokémon porte le numéro 001 du Pokédex ?',
    reponses: ['Bulbizarre', 'Pikachu', 'Salamèche', 'Carapuce'],
    bonne: 0,
    note: 'Bulbizarre ouvre le bal, Pikachu n’est que le vingt-cinquième — et c’est pourtant lui qu’on met sur les boîtes.',
  },
  {
    id: 'pok-04', theme: 'pokemon',
    niveau: 2,
    texte: 'Quelle est l’évolution finale de Carapuce ?',
    reponses: ['Tortank', 'Carabaffe', 'Léviator', 'Aquali'],
    bonne: 0,
    note: 'Carapuce, Carabaffe, Tortank. Les deux canons dans la carapace arrivent à la dernière étape.',
  },
  {
    id: 'pok-05', theme: 'pokemon',
    niveau: 1,
    texte: 'Comment appelle-t-on l’objet qui sert à capturer les Pokémon ?',
    reponses: ['Une Poké Ball', 'Un Pokédex', 'Une Master Card', 'Un Pokéblock'],
    bonne: 0,
    note: 'Le Pokédex, lui, est l’encyclopédie : il décrit, il n’attrape rien. La Master Ball, elle, ne rate jamais — et on n’en a qu’une.',
  },
  {
    id: 'pok-06', theme: 'pokemon',
    niveau: 2,
    texte: 'Quel Pokémon a été créé en laboratoire à partir de Mew ?',
    reponses: ['Mewtwo', 'Dracaufeu', 'Métamorph', 'Porygon'],
    bonne: 0,
    note: 'Toute l’intrigue du premier film. Porygon est bien artificiel lui aussi, mais programmé, pas cloné.',
  },
  {
    id: 'pok-07', theme: 'pokemon',
    niveau: 3,
    texte: 'Ectoplasma est de type Poison et de quel autre type ?',
    reponses: ['Spectre', 'Ténèbres', 'Psy', 'Vol'],
    bonne: 0,
    note: 'Spectre et Poison, un mélange rare à l’époque. Le type Ténèbres n’existait même pas dans la première génération.',
  },
  {
    id: 'pok-08', theme: 'pokemon',
    niveau: 2,
    texte: 'Comment s’appelle la région de la première génération ?',
    reponses: ['Kanto', 'Johto', 'Hoenn', 'Sinnoh'],
    bonne: 0,
    note: 'Kanto, du nom d’une vraie région du Japon. Johto arrive avec la deuxième génération, et on peut y retourner à Kanto — du jamais vu à l’époque.',
  },
  {
    id: 'pok-09', theme: 'pokemon',
    niveau: 3,
    texte: 'Lequel de ces types est efficace contre le type Eau ?',
    reponses: ['Plante', 'Feu', 'Roche', 'Acier'],
    bonne: 0,
    note: 'Plante et Électrik. C’est la seule faiblesse d’un type par ailleurs très tranquille, et la raison pour laquelle on garde un Herbizarre en réserve.',
  },
  {
    id: 'pok-10', theme: 'pokemon',
    niveau: 1,
    texte: 'Quelle organisation poursuit Sacha dans le dessin animé ?',
    reponses: ['La Team Rocket', 'La Team Aqua', 'La Team Galaxie', 'La Team Plasma'],
    bonne: 0,
    note: 'Jessie, James et Miaouss, qui repartent dans le ciel à la fin de chaque épisode. Les autres équipes viennent des générations suivantes.',
  },
  {
    id: 'pok-11', theme: 'pokemon',
    niveau: 3,
    texte: 'Quel Pokémon peut prendre l’apparence de n’importe quel autre ?',
    reponses: ['Métamorph', 'Mimiqui', 'Zorua', 'Kecleon'],
    bonne: 0,
    note: 'Métamorph copie tout sauf les yeux, qui restent les siens. Mimiqui, lui, se déguise en Pikachu avec un drap, et c’est une autre histoire.',
  },
  {
    id: 'pok-12', theme: 'pokemon',
    niveau: 3,
    texte: 'Quel type est apparu avec la sixième génération ?',
    reponses: ['Fée', 'Ténèbres', 'Acier', 'Insecte'],
    bonne: 0,
    note: 'Le type Fée, ajouté pour calmer les Dragons, devenus intouchables. Ténèbres et Acier étaient arrivés quatre générations plus tôt, pour la même raison : rééquilibrer.',
  },

  /* --- Serial killers ------------------------------------------------------- */
  //
  // Le thème regarde du côté des enquêtes, pas des crimes : ce qui a confondu
  // un coupable, ce qu'une police a mis trente ans à comprendre, et les idées
  // reçues que le cinéma a installées. On ne raconte pas les meurtres — un jeu
  // de soirée n'a pas à les détailler, et une affaire résolue est de toute
  // façon plus intéressante qu'une scène de crime.

  {
    id: 'cri-01', theme: 'crimes',
    niveau: 1,
    texte: 'Quel surnom la presse a-t-elle donné au tueur de Londres de 1888 ?',
    reponses: ['Jack l’Éventreur', 'Le Monstre de Whitechapel', 'Le Boucher de Londres', 'L’Ombre de la Tamise'],
    bonne: 0,
    note: 'Le nom vient d’une lettre envoyée à une agence de presse, probablement un faux de journaliste. L’affaire n’a jamais été résolue.',
  },
  {
    id: 'cri-02', theme: 'crimes',
    niveau: 1,
    texte: 'Quelle découverte des années 1980 a bouleversé les enquêtes criminelles ?',
    reponses: ['L’empreinte génétique', 'Le détecteur de mensonge', 'La photographie', 'Le portrait-robot'],
    bonne: 0,
    note: 'Mise au point par Alec Jeffreys en 1984, elle sert dès 1986 — et sa première utilisation judiciaire innocente un suspect avant de confondre le vrai coupable.',
  },
  {
    id: 'cri-03', theme: 'crimes',
    niveau: 1,
    texte: 'Quelle émission française raconte les grandes affaires criminelles depuis 2000 ?',
    reponses: ['« Faites entrer l’accusé »', '« Sept à huit »', '« Enquête exclusive »', '« Zone interdite »'],
    bonne: 0,
    note: 'Christophe Hondelatte y a posé le format : la chronologie de l’enquête, du premier appel au verdict. Deux cents affaires et quelques générations d’insomniaques.',
  },
  {
    id: 'cri-04', theme: 'crimes',
    niveau: 1,
    texte: 'Comment appelle-t-on la façon de procéder qu’un criminel répète d’un crime à l’autre ?',
    reponses: ['Le mode opératoire', 'Le mobile', 'L’alibi', 'La préméditation'],
    bonne: 0,
    note: 'C’est lui qui permet de relier des affaires jusque-là séparées — et c’est souvent ce rapprochement, plus qu’un indice, qui déclenche tout.',
  },
  {
    id: 'cri-05', theme: 'crimes',
    niveau: 2,
    texte: 'Quel criminel a été surnommé « le tueur de l’Est parisien » ?',
    reponses: ['Guy Georges', 'Francis Heaulme', 'Michel Fourniret', 'Patrice Alègre'],
    bonne: 0,
    note: 'Arrêté en 1998 grâce à un fichier génétique encore balbutiant : il a fallu comparer des milliers de profils à la main pour trouver la correspondance.',
  },
  {
    id: 'cri-06', theme: 'crimes',
    niveau: 2,
    texte: 'Quelle unité du FBI a mis au point le profilage criminel ?',
    reponses: ['L’unité des sciences du comportement', 'La police scientifique', 'Le bureau des disparitions', 'La brigade anti-gang'],
    bonne: 0,
    note: 'Créée dans les années 1970 à Quantico, elle a interrogé des dizaines de condamnés pour dresser des portraits types. La série « Mindhunter » raconte ces entretiens.',
  },
  {
    id: 'cri-07', theme: 'crimes',
    niveau: 2,
    texte: 'Quel criminel américain se produisait déguisé en clown lors de fêtes d’enfants ?',
    reponses: ['John Wayne Gacy', 'Richard Ramirez', 'David Berkowitz', 'Gary Ridgway'],
    bonne: 0,
    note: 'Un notable apprécié de ses voisins, photographié avec des élus. C’est l’exemple que citent les criminologues quand on imagine un monstre reconnaissable.',
  },
  {
    id: 'cri-08', theme: 'crimes',
    niveau: 2,
    texte: 'Quel accusé américain a assuré lui-même sa défense lors de son procès de 1979 ?',
    reponses: ['Ted Bundy', 'Charles Manson', 'Jeffrey Dahmer', 'Albert DeSalvo'],
    bonne: 0,
    note: 'Étudiant en droit, il a contre-interrogé les témoins devant les caméras — le premier procès américain retransmis en direct à la télévision.',
  },
  {
    id: 'cri-09', theme: 'crimes',
    niveau: 3,
    texte: 'Quel médecin français a été surnommé « le docteur Satan » ?',
    reponses: ['Marcel Petiot', 'Henri Landru', 'Joseph Vacher', 'Émile Louis'],
    bonne: 0,
    note: 'Condamné en 1946. Il promettait des passages vers l’Amérique du Sud à des gens qui fuyaient l’Occupation — une affaire qui a longtemps gêné la France d’après-guerre.',
  },
  {
    id: 'cri-10', theme: 'crimes',
    niveau: 3,
    texte: 'Quel criminel du Wisconsin a inspiré Norman Bates et Leatherface ?',
    reponses: ['Ed Gein', 'Ted Kaczynski', 'Herbert Mullin', 'Carl Panzram'],
    bonne: 0,
    note: 'Arrêté en 1957. Trois films majeurs lui doivent leur personnage — « Psychose », « Massacre à la tronçonneuse » et « Le Silence des agneaux » — alors que son affaire, elle, ne ressemble à aucun des trois.',
  },
  {
    id: 'cri-11', theme: 'crimes',
    niveau: 3,
    texte: 'Quel criminel américain a été confondu en 2005 par une disquette envoyée à la police ?',
    reponses: ['Dennis Rader', 'Joseph DeAngelo', 'Dennis Nilsen', 'Robert Hansen'],
    bonne: 0,
    note: 'Il avait demandé par courrier si une disquette pouvait être tracée ; on lui a répondu que non. Les métadonnées du fichier portaient son prénom et le nom de son église.',
  },
  {
    id: 'cri-12', theme: 'crimes',
    niveau: 3,
    texte: 'Quelle profession exerçait Harold Shipman, condamné au Royaume-Uni en 2000 ?',
    reponses: ['Médecin généraliste', 'Infirmier', 'Pharmacien', 'Ambulancier'],
    bonne: 0,
    note: 'Un médecin de famille estimé, démasqué par un testament grossièrement falsifié. L’enquête a conduit le pays à revoir entièrement le contrôle des certificats de décès.',
  },

  /* --- Géopolitique --------------------------------------------------------- */

  {
    id: 'geo-01', theme: 'geopolitique',
    niveau: 1,
    texte: 'Combien de membres permanents siègent au Conseil de sécurité de l’ONU ?',
    reponses: ['5', '10', '15', '3'],
    bonne: 0,
    note: 'États-Unis, Russie, Chine, France, Royaume-Uni — les vainqueurs de 1945. Chacun dispose d’un veto, et c’est ce qui bloque le Conseil depuis quatre-vingts ans.',
  },
  {
    id: 'geo-02', theme: 'geopolitique',
    niveau: 1,
    texte: 'Dans quelle ville siège la Commission européenne ?',
    reponses: ['Bruxelles', 'Strasbourg', 'Luxembourg', 'Francfort'],
    bonne: 0,
    note: 'Le Parlement, lui, siège à Strasbourg et travaille à Bruxelles : un déménagement mensuel que personne n’assume et que le traité impose.',
  },
  {
    id: 'geo-03', theme: 'geopolitique',
    niveau: 2,
    texte: 'Quel pays est devenu le plus peuplé du monde en 2023 ?',
    reponses: ['L’Inde', 'La Chine', 'Les États-Unis', 'L’Indonésie'],
    bonne: 0,
    note: 'L’Inde est passée devant la Chine, dont la population recule depuis 2022. Un basculement annoncé depuis des décennies, arrivé plus tôt que prévu.',
  },
  {
    id: 'geo-04', theme: 'geopolitique',
    niveau: 2,
    texte: 'Que signifie le sigle OTAN ?',
    reponses: [
      'Organisation du traité de l’Atlantique Nord',
      'Organisation des territoires alliés du Nord',
      'Office des traités et alliances de l’ONU',
      'Organisation transatlantique des nations',
    ],
    bonne: 0,
    note: 'Fondée en 1949. Son article 5 — une attaque contre l’un est une attaque contre tous — n’a été invoqué qu’une seule fois, après le 11 septembre 2001.',
  },
  {
    id: 'geo-05', theme: 'geopolitique',
    niveau: 1,
    texte: 'Combien d’États membres compte l’Union européenne ?',
    reponses: ['27', '25', '28', '30'],
    bonne: 0,
    note: 'Vingt-sept depuis le départ du Royaume-Uni. La Croatie, arrivée en 2013, reste la dernière entrée.',
  },
  {
    id: 'geo-06', theme: 'geopolitique',
    niveau: 3,
    texte: 'Dans quelle ville siège la Cour pénale internationale ?',
    reponses: ['La Haye', 'Genève', 'Vienne', 'New York'],
    bonne: 0,
    note: 'Aux Pays-Bas, depuis 2002. Ni les États-Unis, ni la Russie, ni la Chine n’en reconnaissent la compétence.',
  },
  {
    id: 'geo-07', theme: 'geopolitique',
    niveau: 2,
    texte: 'Quel détroit sépare l’Iran d’Oman et voit passer une grande part du pétrole mondial ?',
    reponses: ['Le détroit d’Ormuz', 'Le détroit de Malacca', 'Le Bosphore', 'Le détroit de Gibraltar'],
    bonne: 0,
    note: 'Cinquante kilomètres de large au plus étroit, et près d’un cinquième du pétrole mondial. Le fermer est la menace que l’Iran agite à chaque crise.',
  },
  {
    id: 'geo-08', theme: 'geopolitique',
    niveau: 2,
    texte: 'Quelle organisation réunit les grands pays exportateurs de pétrole ?',
    reponses: ['L’OPEP', 'L’AIEA', 'L’OCDE', 'Le FMI'],
    bonne: 0,
    note: 'Fondée en 1960 à Bagdad. En décidant des quotas de production, une réunion de quelques ministres déplace le prix à la pompe dans le monde entier.',
  },
  {
    id: 'geo-09', theme: 'geopolitique',
    niveau: 2,
    texte: 'Que désignent les BRICS à l’origine ?',
    reponses: [
      'Brésil, Russie, Inde, Chine, Afrique du Sud',
      'Belgique, Roumanie, Irlande, Croatie, Suède',
      'Brésil, Russie, Israël, Canada, Suisse',
      'Birmanie, Rwanda, Inde, Chili, Serbie',
    ],
    bonne: 0,
    note: 'L’acronyme vient d’une note d’un économiste de banque en 2001, pour désigner les grands émergents. Les pays concernés l’ont repris à leur compte et en ont fait un club.',
  },
  {
    id: 'geo-10', theme: 'geopolitique',
    niveau: 1,
    texte: 'Quel pays a quitté l’Union européenne en 2020 ?',
    reponses: ['Le Royaume-Uni', 'La Norvège', 'La Suisse', 'L’Islande'],
    bonne: 0,
    note: 'Quatre ans entre le référendum et la sortie effective. La Norvège et la Suisse, elles, ne sont jamais entrées.',
  },
  {
    id: 'geo-11', theme: 'geopolitique',
    niveau: 3,
    texte: 'Quelle organisation arbitre les différends commerciaux entre États ?',
    reponses: [
    ...
    bonne: 0,
    note: 'L’OMC, née en 1995. Son organe d’appel est paralysé depuis 2019, faute de juges nommés — et les litiges s’empilent.',
  },
  {
    id: 'geo-12', theme: 'geopolitique',
    niveau: 2,
    texte: 'Comment appelle-t-on l’influence d’un pays par sa culture plutôt que par la force ?',
    reponses: ['Le soft power', 'Le containment', 'La realpolitik', 'Le protectionnisme'],
    bonne: 0,
    note: 'Le terme est de Joseph Nye, en 1990. La K-pop, Hollywood et la gastronomie française relèvent du même rayon.',
  },
  ...
  {
    id: 'est-19', theme: 'potter', type: 'estimation',
    texte: 'Combien de points rapporte l’attrapeur qui saisit le Vif d’or ?',
    valeur: 150,
    unite: 'points',
    note: 'Cent cinquante, contre dix pour un but. Autrement dit : quinze buts valent une seconde de chance, et tout le monde le fait remarquer depuis vingt-cinq ans.',
  },
  {
    id: 'est-20', theme: 'potter', type: 'estimation',
    texte: 'Combien de marches compte le grand escalier de Poudlard, selon le premier tome ?',
    valeur: 142,
    unite: 'escaliers',
    note: 'Cent quarante-deux escaliers, et non des marches : certains changent de place, d’autres ont une marche piégée où l’on s’enfonce jusqu’au genou.',
  },
  {
    id: 'est-21', theme: 'pokemon', type: 'estimation',
    texte: 'Combien de Pokémon comptait la toute première génération ?',
    valeur: 151,
    unite: 'Pokémon',
    note: 'Cent cinquante et un, Mew compris — et Mew était un secret glissé par un programmeur dans la place mémoire restante, à l’insu de l’éditeur.',
  },
  {
    id: 'est-22', theme: 'pokemon', type: 'estimation',
    texte: 'Combien de types de Pokémon existe-t-il aujourd’hui ?',
    valeur: 18,
    unite: 'types',
    note: 'Dix-huit. Ils étaient quinze à l’origine : Ténèbres et Acier sont arrivés à la deuxième génération, Fée à la sixième.',
  },
  {
    id: 'est-23', theme: 'crimes', type: 'estimation',
    texte: 'Combien de points de concordance la police française retient-elle traditionnellement pour valider une empreinte digitale ?',
    valeur: 12,
    unite: 'points',
    note: 'Douze, un seuil hérité du XIXᵉ siècle et de la méthode Bertillon. D’autres pays ne fixent aucun chiffre et s’en remettent au jugement de l’expert.',
  },
  {
    id: 'est-24', theme: 'geopolitique', type: 'estimation',
    texte: 'Combien de pays sont membres de l’OTAN ?',
    valeur: 32,
    unite: 'pays',
    note: 'Trente-deux depuis l’entrée de la Suède en 2024. Ils étaient douze à la signature, en 1949.',
  },
  {
    id: 'est-25', theme: 'geopolitique', type: 'estimation',
    texte: 'Combien de langues officielles l’Union européenne reconnaît-elle ?',
    valeur: 24,
    unite: 'langues',
    note: 'Vingt-quatre, et tout texte officiel doit exister dans chacune. C’est le plus gros service de traduction du monde.',
  },
  /* --- Dans l'ordre ------------------------------------------------------- */
  ...
  {
    id: 'ord-18', theme: 'potter', type: 'ordre',
    texte: 'Du premier au dernier : ces tomes de la saga',
    elements: [
    ...
    note: 'Tomes un, deux, quatre et sept. Dix ans séparent la parution du premier de celle du dernier, exactement le temps qu’il faut à un lecteur de onze ans pour en avoir vingt et un.',
  },
  {
    id: 'ord-19', theme: 'potter', type: 'ordre',
    texte: 'Dans l’ordre où Harry les a eus comme professeurs de Défense contre les forces du Mal',
    elements: ['Quirrell', 'Lockhart', 'Lupin', 'Maugrey'],
    note: 'Années un à quatre. Le poste était maudit : aucun titulaire n’a tenu deux années de suite, et le livre finit par expliquer pourquoi.',
  },
  {
    id: 'ord-20', theme: 'pokemon', type: 'ordre',
    texte: 'Du plus petit au plus grand : ces Pokémon',
    elements: ['Pikachu', 'Dracaufeu', 'Ronflex', 'Onix'],
    note: 'Quarante centimètres, un mètre soixante-dix, deux mètres dix — et huit mètres quatre-vingts pour Onix, qui tient plus du train que du serpent.',
  },
  {
    id: 'ord-21', theme: 'crimes', type: 'ordre',
    texte: 'De la plus ancienne à la plus récente : ces affaires',
    elements: ['Jack l’Éventreur', 'Marcel Petiot', 'Ted Bundy', 'Guy Georges'],
    note: '1888, les années 1940, les années 1970, les années 1990. Un siècle pendant lequel l’enquête est passée du témoignage à la génétique.',
  },
  {
    id: 'ord-22', theme: 'geopolitique', type: 'ordre',
    texte: 'Du plus ancien au plus récent : ces moments',
    elements: [
    ...
    note: '1945, 1957, 1991, 2007. Entre le premier et le dernier, le monde est passé de deux blocs à aucun.',
  },
  {
    id: 'ord-23', theme: 'geopolitique', type: 'ordre',
    texte: 'De la plus grande économie à la plus petite',
    elements: ['Les États-Unis', 'La Chine', 'Le Japon', 'La France'],
    note: 'Vingt-neuf mille milliards de dollars pour les États-Unis, dix-huit pour la Chine — et la France autour du septième rang mondial, derrière l’Allemagne et l’Inde.',
  },
  /* --- Rafales ------------------------------------------------------------ */
  ...
  {
    id: 'raf-25', theme: 'mots', type: 'rafale',
    texte: 'Vocabulaire',
    affirmations: [
      { texte: 'Un « quidam » est une personne quelconque.', vrai: true },
      { texte: '« Achalandé » veut dire d’abord : qui a beaucoup de clients.', vrai: true },
      { texte: '« Pécuniaire » peut aussi s’écrire « pécunier ».', vrai: false },
      { texte: '« Acception » et « acceptation » veulent dire la même chose.', vrai: false },
      { texte: 'On amène une personne, on apporte une chose.', vrai: true },
    ],
    note: 'Un chaland est un client : un magasin bien achalandé a du monde, pas des rayons pleins. « Pécunier » n’existe pas. Et une acception est un sens de mot, pas un accord.',
  },
  {
    id: 'raf-26', theme: 'potter', type: 'rafale',
    texte: 'Poudlard',
    affirmations: [
      { texte: 'La Mandragore pousse un cri qui peut tuer.', vrai: true },
      { texte: 'Le train pour Poudlard part de la voie 9¾.', vrai: true },
      { texte: 'Poudlard se trouve quelque part en Irlande.', vrai: false },
      { texte: 'Le Choixpeau tient compte de ce que souhaite l’élève.', vrai: true },
      { texte: 'On peut transplaner à l’intérieur de Poudlard.', vrai: false },
    ],
    note: 'Le château est en Écosse, et il est protégé contre le transplanage — c’est même dit et redit, jusqu’à ce que Dumbledore lève l’enchantement pour un cours. Les Mandragores adultes, elles, sont mortelles : d’où les cache-oreilles en cours de botanique.',
  },
  {
    id: 'raf-27', theme: 'potter', type: 'rafale',
    texte: 'Le monde des sorciers',
    affirmations: [
      { texte: 'Voldemort s’appelait Tom Jedusor.', vrai: true },
      { texte: 'Hermione est née de parents sorciers.', vrai: false },
      { texte: 'Les Détraqueurs gardent la prison d’Azkaban.', vrai: true },
      { texte: 'Le Ministère de la Magie est dirigé par Dumbledore.', vrai: false },
      { texte: 'Un Patronus prend la forme d’un animal propre à chacun.', vrai: true },
    ],
    note: 'Hermione est née de parents dentistes moldus, ce qui lui vaut l’insulte du deuxième tome. Et Dumbledore a refusé le poste de ministre plusieurs fois : il se méfiait de ce que le pouvoir lui ferait faire.',
  },
  {
    id: 'raf-28', theme: 'pokemon', type: 'rafale',
    texte: 'Les Pokémon',
    affirmations: [
      { texte: 'Pikachu porte le numéro 25 du Pokédex.', vrai: true },
      { texte: 'Évoli possède plus de cinq évolutions possibles.', vrai: true },
      { texte: 'Magicarpe évolue en Léviator.', vrai: true },
      { texte: 'Miaouss est le Pokémon de départ de Sacha.', vrai: false },
      { texte: 'Le type Dragon est faible contre le type Combat.', vrai: false },
    ],
    note: 'Évoli compte huit évolutions, une par type ou presque. Le Dragon craint la Glace, le Dragon et la Fée — le Combat ne lui fait rien.',
  },
  {
    id: 'raf-29', theme: 'pokemon', type: 'rafale',
    texte: 'Dans le Pokédex',
    affirmations: [
      { texte: 'Le premier jeu Pokémon est sorti dans les années 1990.', vrai: true },
      { texte: 'Le créateur de Pokémon s’est inspiré de sa collection d’insectes.', vrai: true },
      { texte: 'Il existe aujourd’hui plus de mille Pokémon.', vrai: true },
      { texte: 'Mewtwo est apparu avant Mew dans l’histoire du jeu.', vrai: false },
      { texte: 'Le Pokémon le plus lourd tient dans une main.', vrai: false },
    ],
    note: 'Satoshi Tajiri chassait les insectes enfant, et voulait transmettre ça à des enfants de ville : c’est l’origine du jeu. Mewtwo est né de Mew, donc après. Et le plus lourd dépasse les neuf cents kilos.',
  },
  {
    id: 'raf-30', theme: 'crimes', type: 'rafale',
    texte: 'Enquêtes et police scientifique',
    affirmations: [
      { texte: 'Deux vrais jumeaux ont le même ADN.', vrai: true },
      { texte: 'Deux vrais jumeaux ont les mêmes empreintes digitales.', vrai: false },
      { texte: 'Le détecteur de mensonge est admis comme preuve devant un tribunal français.', vrai: false },
      { texte: 'On peut établir un profil génétique à partir de quelques cellules.', vrai: true },
      { texte: 'Les empreintes digitales se forment avant la naissance.', vrai: true },
    ],
    note: 'Les jumeaux partagent l’ADN mais pas les empreintes : celles-ci se forment dans l’utérus, au hasard des contacts. Quant au polygraphe, il mesure le stress et rien d’autre — la justice française ne le reconnaît pas.',
  },
  {
    id: 'raf-31', theme: 'crimes', type: 'rafale',
    texte: 'Idées reçues sur les tueurs en série',
    affirmations: [
      { texte: 'La plupart sont des marginaux que leur entourage trouvait inquiétants.', vrai: false },
      { texte: 'Le terme « serial killer » a été popularisé par le FBI dans les années 1970.', vrai: true },
      { texte: 'Un profil criminel désigne un coupable avec certitude.', vrai: false },
      { texte: 'La plupart des affaires se résolvent par un travail d’enquête classique.', vrai: true },
      { texte: 'Les tueurs en série représentent une part importante des homicides.', vrai: false },
    ],
    note: 'Beaucoup menaient une vie ordinaire, voisins compris — c’est ce qui rend les enquêtes longues. Le profil oriente, il ne prouve rien. Et ces affaires restent une infime part des homicides.',
  },
  {
    id: 'raf-32', theme: 'geopolitique', type: 'rafale',
    texte: 'L’Europe et le monde',
    affirmations: [
      { texte: 'La Suisse n’est pas membre de l’Union européenne.', vrai: true },
      { texte: 'Tous les pays de l’Union européenne ont adopté l’euro.', vrai: false },
      { texte: 'L’espace Schengen compte des pays non membres de l’Union.', vrai: true },
      { texte: 'Le siège de l’ONU se trouve à Genève.', vrai: false },
      { texte: 'La France est le seul pays de l’Union à siéger en permanence au Conseil de sécurité.', vrai: true },
    ],
    note: 'La Pologne, la Suède ou la Hongrie gardent leur monnaie. La Norvège et l’Islande sont dans Schengen sans être dans l’Union. Et l’ONU siège à New York : Genève n’en abrite que le second bureau.',
  },
  /* --- Tu te mets combien ? ------------------------------------------------ */
  //
