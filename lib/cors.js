...
export function enTetesCors(origine) {
  ...
  return {
    ...
    // `authorization` depuis que les comptes existent : c'est par là que passe
    // le jeton de session, et un préflight qui ne l'annonce pas fait refuser la
    // requête par le navigateur avant même qu'elle parte.
